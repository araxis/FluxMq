...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void TestRunnerConsole_UsesFlatCompactRunnerChrome()
    {
        ...
        markup.ShouldContain("RunStateClass(result.Status)");
        markup.ShouldContain("aria-label=\"@($\"Run state {result.Status}\")\"");
        ...
        css.ShouldContain(".test-runner-run-state");
    ...
    public void TestScenarioDesigner_UsesFlatCompactScenarioChrome()
    {
        ...
        markup.ShouldContain("ActiveRunStateText");
        markup.ShouldContain("ActiveRunStateColor");
        markup.ShouldContain("test-run-context-state");
        ...
        css.ShouldContain(".test-run-context-state");
    ...
    public void ScenarioStepEditorDialog_UsesFlatCompactEditorChrome()
    {
        ...
        markup.ShouldContain("class=\"scenario-step-editor-state invalid\"");
