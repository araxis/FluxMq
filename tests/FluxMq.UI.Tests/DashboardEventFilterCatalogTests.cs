...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void ConnectionStateTriggerNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) minmax(0, 1.08fr) 96px;");
    ...
    public void StateReducerNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("state-reducer-rule-title");
        markup.ShouldContain("state-reducer-rule-composer");
        ...
        css.ShouldContain(".state-reducer-rule-title");
        css.ShouldContain(".state-reducer-rule-composer");
        css.ShouldContain("grid-template-columns: minmax(0, 1.48fr) minmax(260px, 0.52fr);");
    ...
    public void FlowAssertionNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("flow-assertion-rule-title");
        markup.ShouldContain("flow-assertion-rule-composer");
        markup.ShouldContain("flow-assertion-rule-sidecar");
        ...
        css.ShouldContain(".flow-assertion-rule-title");
        css.ShouldContain(".flow-assertion-rule-composer");
        css.ShouldContain("grid-template-columns: minmax(0, 1.45fr) minmax(260px, 0.55fr);");
    ...
    public void MessageFilterNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("message-filter-column-heading");
    ...
    public void JsonSchemaValidatorNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("json-schema-validator-editor-surface");
        markup.ShouldContain("aria-label=\"JSON schema workspace\"");
        ...
        css.ShouldContain(".json-schema-validator-editor-surface");
        ...
        css.ShouldContain("background: color-mix(in srgb, var(--flux-surface-2) 4%, transparent);");
        css.ShouldContain("border: 1px solid color-mix(in srgb, var(--flux-border-soft) 42%, transparent);");
        css.ShouldContain("border-bottom: 1px solid color-mix(in srgb, var(--flux-border-soft) 34%, transparent);");
        css.ShouldContain("padding: 12px;");
        css.ShouldContain("grid-template-columns: 172px minmax(0, 1fr);");
        ...
        css.ShouldContain("height: clamp(520px, 68vh, 700px);");
    ...
    public void DynamicMapperNodeWidget_UsesCompactSummaryAndScopedWorkbench()
    {
        ...
        css.ShouldContain("grid-template-rows: minmax(0, 1fr) minmax(128px, 0.2fr);");
        css.ShouldContain("height: clamp(760px, 82vh, 980px);");
        css.ShouldContain("overflow: hidden;");
    ...
    public void RoutingFanNodeWidgets_UseCompactSummaryAndFlatEditors()
    {
        ...
        forkMarkup.ShouldContain("routing-fork-editor-surface");
        forkMarkup.ShouldContain("routing-fork-config-row");
        forkMarkup.ShouldContain("aria-label=\"Routing fork configuration\"");
        ...
        forkMarkup.ShouldContain("routing-fork-port-actions");
        forkMarkup.ShouldContain("routing-fork-port-title");
        ...
        forkMarkup.ShouldContain("routing-fork-port-index");
        ...
        forkCss.ShouldContain(".routing-fork-editor-surface");
        forkCss.ShouldContain(".routing-fork-config-row");
        forkCss.ShouldContain(".routing-fork-port-composer");
        forkCss.ShouldContain(".routing-fork-port-actions");
        forkCss.ShouldContain(".routing-fork-port-title");
        ...
        forkCss.ShouldContain("padding: 12px;");
        ...
        forkCss.ShouldContain(".routing-fork-port-index");
        forkCss.ShouldContain("align-items: center;");
        forkCss.ShouldContain("grid-template-columns: 24px minmax(0, 1fr) 30px;");
        forkCss.ShouldContain(".routing-fork-port-actions ::deep(.routing-fork-add-port.mud-icon-button)");
        ...
        mergeMarkup.ShouldContain("routing-merge-editor-surface");
        mergeMarkup.ShouldContain("routing-merge-config-row");
        mergeMarkup.ShouldContain("aria-label=\"Routing merge configuration\"");
        ...
        mergeMarkup.ShouldContain("routing-merge-port-actions");
        mergeMarkup.ShouldContain("routing-merge-port-title");
        ...
        mergeMarkup.ShouldContain("routing-merge-port-index");
        ...
        mergeCss.ShouldContain(".routing-merge-editor-surface");
        mergeCss.ShouldContain(".routing-merge-config-row");
        mergeCss.ShouldContain(".routing-merge-port-composer");
        mergeCss.ShouldContain(".routing-merge-port-actions");
        mergeCss.ShouldContain(".routing-merge-port-title");
        ...
        mergeCss.ShouldContain("padding: 12px;");
        ...
        mergeCss.ShouldContain(".routing-merge-port-index");
        mergeCss.ShouldContain("align-items: center;");
        mergeCss.ShouldContain("grid-template-columns: 24px minmax(0, 1fr) 30px;");
        mergeCss.ShouldContain(".routing-merge-port-actions ::deep(.routing-merge-add-port.mud-icon-button)");
    ...
    public void RoutingCorrelationAndJoinNodeWidgets_UseCompactSummaryAndFlatEditors()
    {
        ...
        correlationCss.ShouldContain("padding: 12px;");
        ...
        joinCss.ShouldContain("padding: 12px;");
    ...
    public void PayloadInspectorNodeWidget_UsesCompactSummaryAndReadOnlyEditor()
    {
        ...
        markup.ShouldContain("payload-inspector-node-editor-surface");
        markup.ShouldContain("payload-inspector-node-editor-summary");
        markup.ShouldContain("payload-inspector-node-editor-cell");
        markup.ShouldContain("aria-label=\"Payload inspector contract summary\"");
        markup.ShouldContain("payload-inspector-node-editor-contract-list");
        markup.ShouldContain("payload-inspector-node-editor-contract-item");
        markup.ShouldContain("payload-inspector-node-editor-contract-label");
        markup.ShouldContain("payload-inspector-node-editor-tokens");
        markup.ShouldContain("aria-label=\"Payload inspector contracts\"");
        ...
        css.ShouldContain(".payload-inspector-node-editor-surface");
        css.ShouldContain("background: color-mix(in srgb, var(--flux-surface-2) 4%, transparent);");
        css.ShouldContain("border: 1px solid color-mix(in srgb, var(--flux-border-soft) 42%, transparent);");
        css.ShouldContain("padding: 12px;");
        css.ShouldContain(".payload-inspector-node-editor-summary");
        css.ShouldContain("grid-template-columns: minmax(132px, 0.7fr) minmax(0, 1.2fr) minmax(110px, 0.45fr);");
        css.ShouldContain(".payload-inspector-node-editor-cell");
        css.ShouldContain(".payload-inspector-node-editor-contract-list");
        css.ShouldContain("border-top: 1px solid color-mix(in srgb, var(--flux-border-soft) 34%, transparent);");
        css.ShouldContain(".payload-inspector-node-editor-contract-item");
        css.ShouldContain("grid-template-columns: 84px minmax(0, 1fr);");
        css.ShouldContain(".payload-inspector-node-editor-contract-label");
    ...
    public void GenericFlowNodeWidget_UsesFlatFallbackSummary()
    {
        ...
        markup.ShouldContain("generic-node-editor-surface");
        ...
        markup.ShouldContain("generic-node-editor-port-main");
        markup.ShouldContain("PortDirection(port)");
        markup.ShouldContain("PortDirectionClass(port)");
        ...
        css.ShouldContain(".generic-node-editor-surface");
    ...
    public void GeneratedSourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        css.ShouldContain(".generated-source-control-strip");
        ...
        css.ShouldContain(".generated-source-message-list");
        ...
        css.ShouldContain(".generated-source-message-fields");
        css.ShouldNotContain(".generated-source-message-detail");
        css.ShouldContain("grid-template-columns: minmax(152px, 0.9fr) minmax(220px, 1.3fr) 112px 96px minmax(132px, 0.72fr) 30px;");
    ...
    public void ReplaySourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("replay-source-editor-surface");
        markup.ShouldContain("replay-source-session-row");
        markup.ShouldContain("replay-source-playback-row");
        markup.ShouldContain("replay-source-session-state");
        markup.ShouldContain("aria-label=\"Replay source configuration\"");
        markup.ShouldContain("aria-label=\"Replay playback controls\"");
        ...
        css.ShouldContain(".replay-source-editor-surface");
        css.ShouldContain(".replay-source-session-row");
        css.ShouldContain(".replay-source-playback-row");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) 132px;");
        css.ShouldContain("grid-template-columns: minmax(130px, 180px) minmax(130px, 180px);");
    ...
    public void StoredSessionSourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("stored-session-source-editor-surface");
        markup.ShouldContain("stored-session-source-session-row");
        markup.ShouldContain("stored-session-source-session-state");
        markup.ShouldContain("aria-label=\"Stored session source configuration\"");
        markup.ShouldContain("stored-session-source-playback-row");
        markup.ShouldContain("aria-label=\"Stored session playback settings\"");
        markup.ShouldContain("SessionOptionCountCaption");
        ...
        css.ShouldContain(".stored-session-source-editor-surface");
        css.ShouldContain(".stored-session-source-session-row");
        css.ShouldContain(".stored-session-source-session-state");
        css.ShouldContain(".stored-session-source-playback-row");
        ...
        css.ShouldContain("grid-template-columns: minmax(160px, 1fr) minmax(130px, 170px) minmax(130px, 170px);");
