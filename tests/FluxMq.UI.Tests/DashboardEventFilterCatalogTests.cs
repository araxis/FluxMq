...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void StateReducerNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("state-reducer-rule-grid");
        markup.ShouldContain("state-reducer-rule-aside");
        ...
        css.ShouldContain(".state-reducer-rule-aside");
    ...
    public void FlowAssertionNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("flow-assertion-rule-grid");
        markup.ShouldContain("flow-assertion-rule-aside");
        ...
        css.ShouldContain(".flow-assertion-rule-aside");
        css.ShouldContain("border-left: 1px solid color-mix(in srgb, var(--flux-border-soft) 36%, transparent);");
