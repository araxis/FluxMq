...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void MessageFilterNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("message-filter-editor-status");
        markup.ShouldContain("DraftModeCaption");
        markup.ShouldContain("DraftPatternCountCaption");
        ...
        css.ShouldContain("padding: 12px;");
        css.ShouldNotContain("padding: 14px;");
        css.ShouldContain(".message-filter-editor-status");
        css.ShouldContain(".message-filter-editor-status > div");
    ...
    public void JsonSchemaValidatorNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("Source</span>");
        markup.ShouldContain("Schema ID</span>");
        ...
        markup.ShouldContain("Schema file</span>");
        ...
        css.ShouldContain("padding: 12px;");
        css.ShouldContain("grid-template-columns: minmax(150px, 190px) minmax(0, 1fr);");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) 30px;");
        css.ShouldContain("height: clamp(560px, 72vh, 800px);");
        css.ShouldContain("min-height: 560px;");
        css.ShouldContain("@media (max-width: 640px)");
    ...
    public void RoutingSwitchNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("routing-switch-option-row");
        markup.ShouldContain("Label=\"Expression\"");
        markup.ShouldContain("aria-label=\"Routing switch expression\"");
        markup.ShouldContain("@bind-Value=\"_expression\"");
        ...
        css.ShouldContain(".routing-switch-option-row");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) minmax(130px, 170px);");
    ...
    public void ReplaySourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("replay-source-field-label");
        ...
        css.ShouldContain(".replay-source-field-label");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) 132px minmax(120px, 160px) minmax(120px, 160px);");
    ...
    public void StoredSessionSourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("stored-session-source-field-label");
        ...
        css.ShouldContain(".stored-session-source-field-label");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) 128px 142px minmax(120px, 150px) minmax(120px, 150px);");
