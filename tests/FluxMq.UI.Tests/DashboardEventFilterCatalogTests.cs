...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void ConditionRouterNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("condition-router-expression-workspace");
        ...
        css.ShouldContain(".condition-router-expression-workspace");
    ...
    public void RoutingFanNodeWidgets_UseCompactSummaryAndFlatEditors()
    {
        ...
        forkMarkup.ShouldContain("routing-fork-port-workspace");
        ...
        forkCss.ShouldContain(".routing-fork-port-workspace");
        ...
        mergeMarkup.ShouldContain("routing-merge-port-workspace");
        ...
        mergeCss.ShouldContain(".routing-merge-port-workspace");
    ...
    public void StoredSessionSourceNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("stored-session-source-playback-workspace");
        ...
        markup.ShouldContain("stored-session-source-timing-row");
        markup.ShouldContain("Label=\"Playback speed\"");
        ...
        css.ShouldContain(".stored-session-source-playback-workspace");
        css.ShouldContain("background: color-mix(in srgb, var(--flux-surface-2) 4%, transparent);");
        css.ShouldContain("border: 1px solid color-mix(in srgb, var(--flux-border-soft) 42%, transparent);");
        css.ShouldContain("padding: 14px;");
        ...
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) 150px;");
        css.ShouldContain(".stored-session-source-timing-row");
    ...
    public void TimerNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("timer-node-limit-workspace interval");
        ...
        markup.ShouldContain("timer-node-limit-workspace schedule");
        ...
        markup.ShouldContain("timer-node-option-workspace");
        ...
        css.ShouldContain(".timer-node-limit-workspace");
        css.ShouldContain(".timer-node-option-workspace");
