...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void MessageFilterNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        markup.ShouldContain("message-filter-editor-grid");
        ...
        markup.ShouldContain("message-filter-condition-editor");
        ...
        markup.ShouldContain("Label=\"Condition expression\"");
        markup.ShouldContain("aria-label=\"Condition expression\"");
        ...
        css.ShouldContain(".message-filter-editor-grid");
        css.ShouldContain("grid-template-columns: minmax(14rem, 0.82fr) minmax(0, 1.18fr);");
        ...
        css.ShouldContain(".message-filter-condition-editor");
    ...
    public void RoutingCorrelationAndJoinNodeWidgets_UseCompactSummaryAndFlatEditors()
    {
        ...
        correlationMarkup.ShouldContain("Value=\"@_keyExpression\"");
        correlationMarkup.ShouldContain("ValueChanged=\"@SetKeyExpression\"");
        correlationMarkup.ShouldContain("Value=\"@_sideExpression\"");
        correlationMarkup.ShouldContain("ValueChanged=\"@SetSideExpression\"");
        ...
        correlationMarkup.ShouldContain("private async Task SetKeyExpression(string value)");
        correlationMarkup.ShouldContain("private async Task SetSideExpression(string value)");
        ...
        joinMarkup.ShouldContain("Value=\"@_leftKeyExpression\"");
        joinMarkup.ShouldContain("ValueChanged=\"@SetLeftKeyExpression\"");
        joinMarkup.ShouldContain("Value=\"@_rightKeyExpression\"");
        joinMarkup.ShouldContain("ValueChanged=\"@SetRightKeyExpression\"");
        joinMarkup.ShouldContain("Immediate=\"true\"");
        ...
        joinMarkup.ShouldContain("private async Task SetLeftKeyExpression(string value)");
        joinMarkup.ShouldContain("private async Task SetRightKeyExpression(string value)");
    ...
    public void PayloadInspectorNodeWidget_UsesCompactSummaryAndReadOnlyEditor()
    {
        ...
        markup.ShouldContain("payload-inspector-node-meta-item route");
        ...
        markup.ShouldContain("<span class=\"payload-inspector-node-editor-label\">Output</span>");
        ...
        markup.ShouldContain("payload-inspector-node-contract-grid");
        markup.ShouldContain("aria-label=\"Payload inspector contracts\"");
        markup.ShouldContain("payload-inspector-node-contract-card");
        ...
        css.ShouldContain(".payload-inspector-node-contract-grid");
        css.ShouldContain("grid-template-columns: repeat(2, minmax(0, 1fr));");
        css.ShouldContain(".payload-inspector-node-contract-card");
        css.ShouldContain(".payload-inspector-node-contract-card + .payload-inspector-node-contract-card");
        css.ShouldContain("border-left: 1px solid color-mix(in srgb, var(--flux-border-soft) 26%, transparent);");
        ...
        css.ShouldContain(".payload-inspector-node-contract-card > strong");
