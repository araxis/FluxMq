...
public sealed class DashboardEventFilterCatalogTests
{
    ...
    public void RoutingFanNodeWidgets_UseCompactSummaryAndFlatEditors()
    {
        ...
        forkMarkup.ShouldContain("routing-fork-port-section");
        ...
        forkCss.ShouldContain(".routing-fork-port-section");
        ...
        forkCss.ShouldContain("padding-top: 4px;");
        ...
        mergeMarkup.ShouldContain("routing-merge-port-section");
        ...
        mergeCss.ShouldContain(".routing-merge-port-section");
        ...
        mergeCss.ShouldContain("padding-top: 4px;");
    ...
    public void TimerNodeWidget_UsesCompactSummaryAndFlatEditor()
    {
        ...
        css.ShouldContain(".timer-node-config-row");
        css.ShouldContain(".timer-node-secondary-row");
        css.ShouldNotContain(".timer-node-limit-workspace");
        css.ShouldNotContain(".timer-node-option-workspace");
        css.ShouldContain("grid-template-columns: minmax(0, 1fr) minmax(0, 1fr) 148px;");
        css.ShouldContain("grid-template-columns: minmax(118px, 0.42fr) minmax(160px, 0.58fr);");
        css.ShouldContain("grid-template-columns: minmax(132px, 0.38fr);");
        css.ShouldContain("background: color-mix(in srgb, var(--flux-surface-2) 4%, transparent);");
        css.ShouldContain("border: 1px solid color-mix(in srgb, var(--flux-border-soft) 42%, transparent);");
        css.ShouldContain("border-top: 1px solid color-mix(in srgb, var(--flux-border-soft) 42%, transparent);");
        css.ShouldContain("padding: 12px;");
