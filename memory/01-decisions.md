...
- Flow errors should include stable numeric codes using a typed value so dynamic components can route errors without depending on exception types or message text.
