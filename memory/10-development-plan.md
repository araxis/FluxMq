...
Next implementation slice: run the release-readiness checklist manually as far as local tooling allows, then address any concrete failure before calling the V1 path ready for candidate testing.
