...
internal static class FluxMqMqttNodeConfiguration
{
    ...
    private static MqttConnectionProfile GetConnectionProfile(NodeDefinition definition, string nodeType)
    {
        ...
        return new MqttConnectionProfile
        {
            ...
            AllowUntrustedCertificates = ReadBoolOrDefault(profileElement, "allowUntrustedCertificates", defaults.AllowUntrustedCertificates),
            CaCertificatePath = ReadNullableString(profileElement, "caCertificatePath"),
            ClientCertificatePath = ReadNullableString(profileElement, "clientCertificatePath"),
            ClientCertificatePassword = ReadNullableString(profileElement, "clientCertificatePassword"),
