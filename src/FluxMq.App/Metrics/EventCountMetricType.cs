...
public sealed class EventCountMetricType : IFluxMetricType<double>
{
    ...
    public IReadOnlyList<FluxMetricParameterDescriptor> Parameters { get; } =
    [
        EventFilterParameters.Window(),
        EventFilterParameters.EventType,
        EventFilterParameters.TopicStartsWith,
        EventFilterParameters.TopicNotStartsWith,
        EventFilterParameters.Status,
        EventFilterParameters.Qos,
        EventFilterParameters.Retain
    ];
